...
export function ThemeSwitch() {
  ...
  return (
    <button
      ...
      className="group relative z-30 rounded-full bg-white/90 px-2 py-2 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
